...
//UserDefault 获取Float
func userGetFloat(key: String) -> Float {
    let defaults = UserDefaults.standard
...
//UserDefault 获取Float
func userGetFloat(key: String,defaultValue:Float) -> Float {
    let defaults = UserDefaults.standard
    let dict =  defaults.dictionaryRepresentation()
    if !dict.keys.contains(key){
        return defaultValue
...
func userGetDouble(key: String) -> Double {
    let defaults = UserDefaults.standard
...
//UserDefault 获取字符串
func userGetString(key: String,defaultValue:String) -> String? {
    let defaults = UserDefaults.standard
    let dict =  defaults.dictionaryRepresentation()
    if !dict.keys.contains(key){
        return defaultValue
